...
DataManager.loadMapData = function(mapId) {
    if (mapId > 0) {
        ...
        this._mapLoader = ResourceHandler.createLoader('data_Trek/' + filename, this.loadDataFile.bind(this, '$dataMap', filename));
...
StorageManager.localFileDirectoryPath = function() {
    ...
    return path.join(base, 'save_Trek/');
};
